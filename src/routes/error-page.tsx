...
export const ErrorPage = () => {
  ...
  return (
    <section className="max-w-[1000px] mx-auto lg:my-0 text-slate-100  h-auto flex flex-col justify-center items-start min-h-screen p-0">
      <h1 className="text-4xl font-bold leading-tight text-red-400 lg:text-8xl">Oops!</h1>
      <h2 className="mt-1.5 text-slate-400 lg:text-7xl text-3xl font-bold">Sorry, an unexpected error has occurred.</h2>
