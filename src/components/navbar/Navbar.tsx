            ...
            <div>
              ...
              >
                <div className="relative inline-block w-8 h-6 -top-2">
                  <div className="absolute top-1/2 right-0 w-8 h-0.5 rounded-sm bg-red-400 transform duration-200 delay-0 rotate-0 ease-[cubic-bezier(0.55, 0.055, 0.675, 0.19)] before:w-10 before:-top-2.5  before:bg-red-400 before:h-0.5 before:rounded-sm before:absolute before:right-0 after:w-5 after:-bottom-2.5  after:bg-red-400 after:h-0.5 after:rounded-sm after:absolute after:right-0"></div>
                </div>
              </button>
              <aside
                aria-hidden="true"
